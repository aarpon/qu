...
#   *     Matteo Jucker Riva - Resnet integration
#   *******************************************************************************/
#
...
@dataclass
class ResnetSegmenterSettings:
    """Settings for the Resnet segmenter."""
    # TODO : add other settings from Resnet?
    # List of relevant params that could be added to settings
    #       spatial_dims=
    #         in_channels=
    #         out_channels=
    #         norm_type=
