# -*- coding: utf-8 -*-
#
# qu documentation build configuration file, created by
...
project = u'qu'
copyright = u'2021, Aaron Ponti'
author = u'Aaron Ponti'
...
man_pages = [
    (master_doc, 'napari-cookiecutterplugin_name', u'qu Documentation',
     [author], 1)
]
